...
Hiervoor is zowel een app als een website nodig: De gezinnen kunnen via hun app herinneringen krijgen voor trainingen van de hond, of voor medicijnen dat de hond moet innemen\texttt{...} Daarnaast kan de trainer via zijn computer de verslagen van trainingen uploaden die belangrijk zijn om te weten waarop er nog getraind moet worden.
...
\subsection*{Taal}
Er bestaan enorm veel programmeertalen. Wij hebben op basis van voorkennis en onderzoek meteen een selectie gemaakt tot 6 talen: Java, JavaScript, Python, Kotlin, C en C++. \\ 
JavaScript en Kotlin blijken de beste programmeertalen te zijn om een app te bouwen. Zowel Java als Kotlin zijn officiële programmeertalen voor Android development, daardoor sluiten ze goed aan op het besturingssysteem Android. 
Het is de bedoeling om een web app te ontwikkelen. Dit is een app waarvoor het mogelijk is om die te benaderen met een browser. Dit wordt het best gedaan met talen die populair zijn in de webdevelopment wereld, bijvoorbeeld Java. %of een hybride app?
\subsection*{App}
