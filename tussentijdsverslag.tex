...
\subsection{Taal}
% documentatie nodig omdat het te moeilijk is om zelf te ontwikkelen gebruiken we java
% kotlin omdat het makkelijk aan te leren is
% javascript er zijn niet veel andere opties
