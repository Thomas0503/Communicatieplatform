...
\begin{document}
	...
	Bij documenten krijgt een lid van het pleeggezin een chronologisch overzicht van verschillende documenten. Zij zijn opgeslagen in de database en vallen te downloaden. Die documenten zijn specifiek gericht voor het gezin van een bepaalde pleeghond. Geen ander gezin kan aan deze informatie. \\
	De trainer heeft diezelfde documenten geüpload. Hij kiest voor wie hij bestanden wil uploaden: doet hij dit voor één specifieke hond of voor alle honden. Dan moet de trainer een pdf-file selecteren, wat duidelijk wordt weergegeven op de app. Daarna moet hij deze uploaden, op dat moment worden die documenten ook geüpload naar de database. \\
