...
\begin{document}
	...
	\\
	Firebase heeft als voordeel dat het een populair platform is, waardoor er ook een uitgebreide online documentatie \cite{Firebase} beschikbaar is. Het platform is wel maar beperkt gratis. Wegens het verwachte lage gebruikersaantal van de app en de website zal er toch geen of slechts een zeer beperkte kostprijs zijn.
	\\
	Uit de twee databases van Firestore verkiezen we uiteindelijk Cloud Firestoree. Deze \cite{Firebase} wordt namelijk over het algemeen beschouwd als een verbetering van de oudere Realtime database. Daarnaast is het ook eenvoudiger om data te filteren in Firestore.	
	\newpage
...
\item Dagboek
	...
	\end{itemize}	
	 ...
	 Een overzicht van de structuur van de app en website is te vinden op pagina \pageref{flowchart}.
	\subsection{Database}
