...
\begin{document}
	...
	Voor het inloggen wordt gebruik gemaakt van \textit{Firebase Authentication}, een ingebouwde functionaliteit in de gebruikte database die zorgt voor een betere bescherming van de wachtwoorden van de gebruikers. Elke gebruiker kan met een door ons gekregen account via een email en bijhorend wachtwoord inloggen, zoals weergegeven in figuur \ref{App_login} voor de app. Wanneer een juiste email-wachtwoord combinatie wordt ingegeven, wordt de gebruiker doorverwezen naar de hoofdpagina (figuur \ref{App_homepage}) voor de app en chat voor de website (figuur \ref{website_homepage}). Op de hoofdpagina van de applicatie zijn de vier hoofdfuncties terug te vinden: chat, documenten, kalender en dagboek. \\ 
	...
	\begin{figure}[h]
	\centering
	\includegraphics[width=1.0\textwidth]{screen_web_dagboek}
	\caption{moet nog mooiere afb Schermafbeelding van ... van de website met 1) de filteroptie (pleeggezinnen beschikken niet over de optie om het dagboek van een andere gebruiker te zien) 2) statistieken 3) De ...}\label{website_homepage}
	\end{figure}
	...
	\caption{moet nog mooiere afb Schermafbeelding van ... van de website met 1) de filteroptie (pleeggezinnen beschikken niet over de optie om het dagboek van een andere gebruiker te zien) 2) statistieken 3) De ...} \label{web_documenten}
	\end{figure}
	...
	\centering
	\includegraphics[width=1.0\textwidth]{screen_web_dagboek.jpg}
	\caption{moet nog mooiere afb Schermafbeelding van ... van de website met 1) de filteroptie (pleeggezinnen beschikken niet over de optie om het dagboek van een andere gebruiker te zien) 2) statistieken 3) De ...}\label{web_kalender}
	\end{figure}
	...
	\begin{figure}[h]
		...
		\begin{minipage}[t]{0.17\linewidth}
			...
			\caption{Dagboek menu \\ trainer}\label{App_trainerdagbmenu}
		\end{minipage}
	\end{figure}
	\begin{figure}[h]
		\centering
		\includegraphics[width=1.0\textwidth]{screen_web_dagboek.jpg}
		\caption{moet nog mooiere afb Schermafbeelding van ... van de website }
