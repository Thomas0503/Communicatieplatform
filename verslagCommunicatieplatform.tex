...
\begin{document}
	...
	\subsection{Chat}
	Indien er doorgeklikt wordt op chat, wordt er een overzicht getoond van de alle gebruikers. Bovenaan is er een zoekbalk te vinden die ervoor zorgt dat chats makkelijk worden teruggevonden indien het overzicht van gebruikers lang is. Hierbij kan er doorgeklikt worden naar het gesprek met die gebruiker. Die berichten worden geüpload naar en vanuit de database. Zo kan er snel gecommuniceerd worden tussen het pleeggezin en de trainer mochten er bijkomende problemen of vragen, omtrent bijvoorbeeld de volgende training, zijn. Trainers kunnen ook onderling met elkaar chatten, zodat ze makkelijk kunnen afspreken voor bijvoorbeeld een meeting. Indien pleeggezinnen willen afspreken om bijvoorbeeld samen te gaan wandelen, kunnen ze ook naar elkaar sturen om af te spreken.
	...
	% vriendenlijst maken ipv iedereen zien voor bij de chat
